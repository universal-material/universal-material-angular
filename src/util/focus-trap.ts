...
const FOCUSABLE_ELEMENTS_SELECTOR = [
  'a[href]', 'buttons-example:not([disabled])', 'input:not([disabled]):not([type="hidden"])', 'select:not([disabled])',
 ...
 */
export const uFocusTrap = (element: HTMLElement, stopFocusTrap$: Observable<any>) => {
